...
var Slider = function (_React$Component) {
  ...
  Slider.prototype.trimAlignValue = function trimAlignValue(v, nextProps) {
    ...
    var _props4 = _extends({}, this.props, nextProps || {}),
        marks = _props4.marks,
        step = _props4.step,
        min = _props4.min,
        max = _props4.max,
  ...
  Slider.prototype.render = function render() {
    ...
    var _props5 = this.props,
        ...
        tipAlign = _props5.tipAlign,
        tipContainer = _props5.tipContainer,
        tipAlwaysVisible = _props5.tipAlwaysVisible,
    ...
    var commonHandleProps = {
      ...
      tipAlwaysVisible: tipAlwaysVisible,
    ...
    var sliderClassName = (0, _classnames2["default"])((_classNames3 = {}, _defineProperty(_classNames3, prefixCls, true), _defineProperty(_classNames3, prefixCls + '-with-marks', Object.keys(marks).length), _defineProperty(_classNames3, prefixCls + '-disabled', disabled), _defineProperty(_classNames3, prefixCls + '-vertical', this.props.vertical), _defineProperty(_classNames3, className, !!className), _classNames3));
